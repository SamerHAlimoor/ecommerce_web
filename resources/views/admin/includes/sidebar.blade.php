    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                ...
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('admin.main.categories')}}"
                                          data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                    </li>
                    <li><a class="menu-item" href="{{route('admin.main.categories.create')}}" data-i18n="nav.dash.crypto">أضافة
                        قسم جديد </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item"><a href="{{ route('admin.brands') }}"><i class="la la-male"></i>
                ...
                <span
                    class="badge badge badge-warning  badge-pill float-right mr-2">{{App\Models\Brand::Selection() ->count()}}</span>
            </a>
                <ul class="menu-content">
            ...
            <li class="nav-item"><a href=""><i class="la la-male"></i>
                ...
                <span
                    class="badge badge badge-warning  badge-pill float-right mr-2">{{App\Models\Product::Selection() ->count()}}</span>
            </a>
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{ route('admin.products.general.index') }}"
                                          data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                    </li>
            ...
            <li class=" nav-item"><a href="#"><i class="la la-television"></i><span class="menu-title"
                                                                                    data-i18n="nav.templates.main">{{__('admins/sidebar.settings')}}</span></a>
                <ul class="menu-content">
                    <li><a class="menu-item" href="#" data-i18n="nav.templates.vert.main">{{__('admins/sidebar.MeansOfDelivery')}}</a>
                        <ul class="menu-content">
                            <li><a class="menu-item" href="{{route('edit.shippings.methods','free')}}"
                                   data-i18n="nav.templates.vert.classic_menu">{{__('admins/sidebar.freeDelivery')}}</a>
                            </li>
                            <li><a class="menu-item" href="{{route('edit.shippings.methods','inside')}}">{{__('admins/sidebar.innerDelivery')}}</a>
                            </li>
                            <li><a class="menu-item" href="{{route('edit.shippings.methods','outline')}}"
                                   data-i18n="nav.templates.vert.compact_menu">{{__('admins/sidebar.outerDelivery')}}</a>
                            </li>
