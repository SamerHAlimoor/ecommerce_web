            ...
            <div class="collapse navbar-collapse" id="navbar-mobile">
               ...
               <img style="height: 30px;width: 30px" src="
                   {{asset('assets/admin/images/icons/user.png')}}"
                    ...
                    <li class="dropdown dropdown-user nav-item">
                        <a class="dropdown-toggle nav-link dropdown-userlink" href="#" data-toggle="dropdown"> {{ (LaravelLocalization::getCurrentLocaleName()=='Arabic')?__('admins/lang.Arabic'):LaravelLocalization::getCurrentLocaleName()}}
